...
public class Car {
     ...
     * @param capacity is the maximum number of passengers that can exist on the train
     */
     ...
     * @param p is the new passenger that we're attempting to add to the train 
     */
     ...
     * @param d is the passenger we're attempting to remove from the train
     */
